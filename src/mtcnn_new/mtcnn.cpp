...
#include "models/mtcnn_new/det1.param.h"
#include "models/mtcnn_new/det2.param.h"
#include "models/mtcnn_new/det3.param.h"
#include "models/mtcnn_new/det1.bin.h"
#include "models/mtcnn_new/det2.bin.h"
#include "models/mtcnn_new/det3.bin.h"
...
MTCNN::MTCNN() {
    ...
    */
    ...
    pnet_.load_param_mem((char *)det1_param);
    pnet_.load_model(det1_bin);

	rnet_.load_param_mem((char *)det2_param);
    rnet_.load_model(det2_bin);

	onet_.load_param_mem((char *)det3_param);
    onet_.load_model(det3_bin);
