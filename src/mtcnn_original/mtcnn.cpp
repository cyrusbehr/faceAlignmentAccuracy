...
#include "models/mtcnn_original/det1_param.h"
#include "models/mtcnn_original/det2_param.h"
#include "models/mtcnn_original/det3_param.h"
#include "models/mtcnn_original/det1_bin.h"
#include "models/mtcnn_original/det2_bin.h"
#include "models/mtcnn_original/det3_bin.h"
...
{
	/*
	Pnet.load_param(fmemopen(det1_param, det1_param_len, "r"));
	Pnet.load_model(fmemopen(det1_bin, det1_bin_len, "r"));

	Rnet.load_param(fmemopen(det2_param, det2_param_len, "r"));
	Rnet.load_model(fmemopen(det2_bin, det2_bin_len, "r"));

	Onet.load_param(fmemopen(det3_param, det3_param_len, "r"));
	Onet.load_model(fmemopen(det3_bin, det3_bin_len, "r"));
	*/
